...
<table class="table datatable">
    <thead>
        <tr>
            ...
            <th scope="col">Berat (gram)</th> <th scope="col">Foto</th>
            <th scope="col"></th>
        </tr>
    </thead>
    <tbody>
            ...
            <form action="<?= base_url('produk/edit/' . $produk['id']) ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="berat" class="form-control" id="berat" value="<?= $produk['berat'] ?>" placeholder="Contoh: 1500 untuk 1.5kg" required>
                    </div>
                    <img src="<?php echo base_url() . "img/" . $produk['foto'] ?>" width="100px">
        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url('produk') ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="name">Berat (gram)</label>
                        <input type="number" name="berat" class="form-control" id="berat" placeholder="Contoh: 1500 untuk 1.5kg" required>
                    </div>
                    <div class="form-group">
                        <label for="name">Foto</label>
                        <input type="file" class="form-control" id="foto" name="foto">
